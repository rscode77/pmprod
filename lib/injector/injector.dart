...
import 'package:pmprod/repositories/network_part_operation_repository.dart';
...
class Injector {
  ...
  void _init() {
    ...
    getIt.registerLazySingleton<WorkPlanRepository>(() => NetworkWorkPlanRepository(dio: _dio));
  }
}
