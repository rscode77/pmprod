...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  Future<void> _onLoginInitialEvent(LoginEvent event, Emitter<LoginState> emit) async {
    emit(LoginLoading());
  ...
  Future<void> _onLogoutUserEvent(LogoutUserEvent event, Emitter<LoginState> emit) async {
